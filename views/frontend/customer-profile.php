...
$listcart = Cart::cartContent();
   ...
   $order->deliveryusername = $customer->uername;
   $order->deliveryphone = $customer->phone;
   $order->deliveryemail = $customer->email;
   $order->deliveryaddress = $customer->addres;
            ...
            <div class="col-md-3 order-2 order-md-1">
               <ul class="list-group mb-3 list-category">
                  ...
                  <li class="list-group-item">
                     <a href="index.php?option=customer-profile">Thông tin tài khoản</a>
                  </li>
                  <li class="list-group-item">
                     <a href="index.php?option=cart">Quản lý đơn hàng</a>
                  </li>
                  <li class="list-group-item">
                     <a href="index.php?option=profile-changepassword">Đổi mật khẩu</a>
                  </li>
               </ul>
            </div>
            <div class="col-md-9 order-1 order-md-2">
               ...
               <table class="table table-borderless">
                  ...
                  <tr>
                     ...
                     <td><?= $customer->username; ?> <a href="index.php?option=profile-changepassword">Đổi mật khẩu</a> </td>
                  </tr>
                  <tr>
