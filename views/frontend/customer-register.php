...
if (isset($_POST["REGISTER"])) {
   ...
   if ($existingUser) {
      ...
      // Nếu chưa tồn tại, tiến hành tạo mới Customer
      ...
      // Lưu thông tin Customer mới vào database
      $newCustomer->save();
...
<form action="index.php?option=customer-register" method="post">
      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="mb-3">
                  <button class="btn btn-main" type="submit" name="REGISTER">Đăng ký</button>
               </div>
