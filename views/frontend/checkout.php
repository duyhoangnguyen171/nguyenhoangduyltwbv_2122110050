...
if (isset($_POST['XACNHAN']) && count($listcart) > 0 && $customer !== null) {
   // luu vao database
   $order = new Order();
...
//kiểm tra khóa sesion user_id đã được thiết lập chưa
         ...
         <div class="col-md-6">
            <form action="index.php?option=checkout" method="post">
               ...
               <?php if (isset($_SESSION["iscustom"])) : ?>
                  ...
                  <div class="mb-3">
                     <label for="mail">Điện thoại</label>
                     <input type="text" name="phone" value="<?= $customer->email; ?>" id="phone" class="form-control" placeholder="Nhập điện thoại" readonly>
                  </div>
                  <div class="mb-3">
                     <label for="phone">Email</label>
                     <input type="text" name="email" value="<?= $customer->phone; ?>" id=" phone" class="form-control" placeholder="Nhập điện thoại" readonly>
                  </div>
                  <div class="mb-3">
                     <label for="address">Địa chỉ</label>
                     <input type="text" name="address" value="<?= $customer->address; ?>" id="address" class="form-control" placeholder="Nhập địa chỉ" readonly>
                  </div>
                  ...
                  <div class="thanhtoan mb-4">
                     ...
                     <div class="p-4 border bankinfo">
                        ...
                        <p>STK: 101717171717</p>
                        <p>Chủ tài khoản: Nguyễn Hoàng Duy</p>
                     </div>
                  </div>
                  <div class="text-end">
