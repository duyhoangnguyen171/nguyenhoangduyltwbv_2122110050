      ...
      <div class="row">
         ...
         <div class="col-md-6">
            ...
            <div class="mb-3 product-size">
               <input id="sizexxzl" type="radio" class="d-none" value="xl" name="size">
               <label for="sizexl" class="bg-info p-2 px-3">39</label>
               <input id="sizexxzl" type="radio" class="d-none" value="xl" name="size">
               <label for="sizexl" class="bg-info p-2 px-3">40</label>
               <input id="sizexxzl" type="radio" class="d-none" value="xl" name="size">
               <label for="sizexl" class="bg-info p-2 px-3">41</label>
               <input id="sizexxzl" type="radio" class="d-none" value="xl" name="size">
               <label for="sizexl" class="bg-info p-2 px-3">42</label>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
               <a class="btn btn-main" href="index.php?option=cart">Mua ngay</a>
