      ...
      <div class="container">
         <div class="row">
            <div class="col-6 col-sm-6 col-md-2 py-1">
               <a href="http://localhost/NguyenHoangDuy_2122110050_LTW/">
                  <img  src="public/images/logocuaduy.jpg" class="img-fluid" alt="Logo">
               </a>
            </div>
               ...
               <div class="call-login--register border-bottom">
                  <ul class="nav nav-fills py-0 my-0">
                     ...
                     <?php else : ?>
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="index.php?option=customer-register">Đăng ký</a>
