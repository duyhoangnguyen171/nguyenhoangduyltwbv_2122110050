               ...
               <div class="card-header">
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        href="index.php?option=brand">Tất cả</a>
                        <a class="btn btn-sm btn-warning "
                         href="index.php?option=brand&cat=trash">
                         Thùng rác</a>
                     </div>
                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    ...
                                    <?php if($item->status==1):?>
                                       ...
                                       <?php endif;?>
                                       <a  href="index.php?option=brand&cat=edit&id=<?= $item->id;?>" class="btn btn-warning btn-xs">
