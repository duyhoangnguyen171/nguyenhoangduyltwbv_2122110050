...
//SELECT * FROM topic WHERE  status!=0 AND .... ORDERBY create_by DESC
      ...
      <section class="content">
         <div class="card">
            <div class="card-header">
               <div class="row">
                  <div class="col-md-6">
                     <a class="btn btn-sm btn-info " href="index.php?option=topic">Tất cả</a>
                     <a class="btn btn-sm btn-warning " href="index.php?option=topic&cat=trash">
                        Thùng rác</a>
                  </div>
