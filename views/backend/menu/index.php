...
use App\Models\Menu;
//select * from Menu where status!='0' and ... orderby created_at desc...
//status =1 --> hiện trang người dùng
// =2 --? không hiện
// =0 --> rác
$list = Menu::where('status', '!=', 0)
   ->select('status', 'id', 'link', 'name', 'level')
                  ...
                  <div class="accordion" id="accordionExample">
                     ...
                     <div class="card mb-0">
                        ...
                        <div id="collapseBrand" class="collapse" aria-labelledby="headingBrand" data-parent="#accordionExample">
                           <div class="card-body p-3">
                              <div class="form-check">
                                 <input name="BrandId[]" class="form-check-input" type="checkbox" value="" id="BrandId">
